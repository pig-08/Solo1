...
public class LineMovement4 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            for (int i = 0; i < ButtonStars4._check.Length; i++)
                ButtonStars4._check[i] = false;
            foreach (Button item in ButtonStars4._stars)
    ...
    private void LineCkeck()
    {
        ...
        {
            for (int i = 0; i < ButtonStars4._check.Length; i++) ButtonStars4._check[i] = false;
        ...
        {
            if (ButtonStars4._check[0] && ButtonStars4._check[2] && gameObject.name == "Line5")
            {
                if (!lineCheck[gameObject.name[4] - 48])
                {
                    _line[gameObject.name[4] - 48].color = Color.white;
                    ButtonStars4._check[ButtonStars4.buttonCount] = false;
            ...
            else if (ButtonStars4._check[0] && ButtonStars4._check[3] && gameObject.name == "Line1")
            {
                if (!lineCheck[gameObject.name[4] - 48])
                {
                    _line[gameObject.name[4] - 48].color = Color.white;
            ...
            if (ButtonStars4._check[0] && ButtonStars4._check[5] && gameObject.name == "Line:(10)")
            {
                if (!lineCheck[gameObject.name[4] - 48])
                {
                    _line[gameObject.name[4] - 48].color = Color.white;
            ...
            else if (ButtonStars4._check[1] && ButtonStars4._check[2] && gameObject.name == "Line3")
            {
                if (!lineCheck[gameObject.name[4] - 48])
                {
                    _line[gameObject.name[4] - 48].color = Color.white;
            ...
            else if (ButtonStars4._check[1] && ButtonStars4._check[5] && gameObject.name == "Line2")
            {
                if (!lineCheck[gameObject.name[4] - 48])
                {
                    _line[gameObject.name[4] - 48].color = Color.white;
            ...
            else if (ButtonStars4._check[1] && ButtonStars4._check[4] && gameObject.name == "Line0")
            {
                if (!lineCheck[gameObject.name[4] - 48])
                {
                    _line[gameObject.name[4] - 48].color = Color.white;
            ...
            else if (ButtonStars4._check[1] && ButtonStars4._check[3] && gameObject.name == "Line6")
            {
                if (!lineCheck[gameObject.name[4] - 48])
                {
                    _line[gameObject.name[4] - 48].color = Color.white;
            ...
            else if (ButtonStars4._check[2] && ButtonStars4._check[3] && gameObject.name == "Line9")
            {
                if (!lineCheck[gameObject.name[4] - 48])
                {
                    _line[gameObject.name[4] - 48].color = Color.white;
            ...
            else if (ButtonStars4._check[2] && ButtonStars4._check[4] && gameObject.name == "Line8")
            {
                if (!lineCheck[gameObject.name[4] - 48])
                {
                    _line[gameObject.name[4] - 48].color = Color.white;
            ...
            else if (ButtonStars4._check[3] && ButtonStars4._check[4] && gameObject.name == "Line4")
            {
                if (!lineCheck[gameObject.name[4] - 48])
                {
                    _line[gameObject.name[4] - 48].color = Color.white;
            ...
            else if (ButtonStars4._check[4] && ButtonStars4._check[5] && gameObject.name == "Line7")
            {
                if (!lineCheck[gameObject.name[4] - 48])
                {
                    _line[gameObject.name[4] - 48].color = Color.white;
